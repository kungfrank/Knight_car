...
class LineDetectorNode(object):
    def __init__(self):
        ...
        self.sub_color_l = rospy.Subscriber("~color_l", String, self.cbSetLineColorL, queue_size=1)
        self.sub_color_r = rospy.Subscriber("~color_r", String, self.cbSetLineColorR, queue_size=1)
        self.sub_color_stop = rospy.Subscriber("~color_stop", String, self.cbSetStopColor, queue_size=1)
...
#             self.detector_config = c
    ...
    def cbSetLineColorL(self, color):
        self.color_l = color.data

    def cbSetLineColorR(self, color):
        self.color_r = color.data

    def cbSetStopColor(self, color):
        self.color_stop = color.data
    ...
    def processImage_(self, image_msg):
        ...
        white = self.detector.detectLines(self.color_l)
        yellow = self.detector.detectLines(self.color_r)
        red = self.detector.detectLines(self.color_stop)
