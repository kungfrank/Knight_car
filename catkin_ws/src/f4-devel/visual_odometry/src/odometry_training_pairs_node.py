...
class OdometryTrainingPairsNode(object):
    def __init__(self):
        ...
        ## Parameters TODO make param file and read from there
        self.stop_line_max_age = 1.0 # [sec] time don't use stop_line_reading msg pairs more than this far apart
        self.lane_pose_max_age = 1.0 # [sec] time don't use lane_pose msg pairs more than this far apart
        self.wheels_cmd_max_age = 2.0 # [sec] throw away wheels_cmd's older than this
