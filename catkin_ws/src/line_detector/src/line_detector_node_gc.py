...
#             self.detector_config = c
	...
	hsv_green1 = (38,25,100)
	hsv_green2 = (50,60,200)

	hsv_white1 = (0,20,0)
	hsv_white2 = (60,60,255)
	...
	if len(lines_2)>0:
    		...
    		flag_signs = (np.logical_and(bw_2[y3,x3]>0, bw_2[y4,x4]>0)).astype('int')*2-1
        ...
        if len(lines_2) > 0:
            lines_normalized_white = ((lines_2 + arr_cutoff) * arr_ratio)
            segmentList.segments.extend(self.toSegmentMsg(lines_normalized_white, normals, 0))
        ...
        if self.verbose:
            ...
            drawLines(image_with_lines, lines_2, (0, 0, 0))
