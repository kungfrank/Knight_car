...
if __name__ == '__main__':
    rospy.init_node('static_object_detector_node',anonymous=False)
    static_object_detector_node = StaticObjectDetectorTesterNode()
    rospy.on_shutdown(static_object_detector_node.onShutdown)
    rospy.spin()