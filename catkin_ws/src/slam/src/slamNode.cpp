...
private:
	...
	ros::Subscriber number_stream_sub_; // interface to the number_stream topic
...
moving_average_count_(0)
{
	...
	number_stream_sub_ = nh_.subscribe("number_stream", 1,
	&SumAndAverageNode::numberStreamCallback, this);
	...
	private_nh.param("moving_average_period", moving_average_period_,
	moving_average_period_);
	...
	&SumAndAverageNode::timerCallback, this);
